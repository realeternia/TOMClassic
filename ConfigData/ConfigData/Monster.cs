namespace ConfigDatas
{
	public class MonsterConfig
	{
		...
		public MonsterConfig(int Id,string Name,string Ename,string EnameShort,int Star,int Type,int Attr,int Cost,int AtkP,int VitP,int Modify,int Def,int  Mag,int Spd,int Hit,int Dhit,int Crt,int Luk,double Sum,int Range,int Mov,string Arrow,RLVector3List Skills,double[] BuffImmune,double[] AttrDef,int Res,int Icon,string Cover,int IsSpecial,int IsNew,double VsMark,string Remark)
		{
			this.Id= Id;
			this.Name= Name;
			this.Ename= Ename;
