    ...
    internal class FastBattle
    {
        ...
        private void TimerProc()
        {
            while (true)
            {
                ...
                if (roundMark % 10 == 0)
                {
                   // AIStrategyContext.OnTimePast(BattleManager.Instance.PlayerManager.RightPlayer);
                  //  AIStrategyContext.OnTimePast(BattleManager.Instance.PlayerManager.LeftPlayer);
                }
